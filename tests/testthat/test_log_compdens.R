...
#  expect_equal(comppostprob(gig,data2),old.comppostprob.default(gig,x,s,2))
  ...
  expect_equal(comppostprob(g,set_data(-10,0.5)),cbind(c(2/3,1/3)))
  expect_equal(comppostprob(g,set_data(-20,0.5)),cbind(c(2/3,1/3)))
})