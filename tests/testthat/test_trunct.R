...
test_that("comp_postmean2 is 0 for null", {
  set.seed(1)
  z=rnorm(10)
  expect_equal(comp_postmean2(unimix(1,0,0),set_data(z,rep(1,10),NULL)),matrix(0,10,nrow=1))
  expect_equal(comp_postmean2(unimix(1,0,0),set_data(z,rep(1,10),4)), matrix(0,10,nrow=1))
  expect_equal(comp_postmean2(normalmix(1,0,0),set_data(z,rep(1,10),NULL)),matrix(0,10,nrow=1))
...
test_that("comp_postmean2.unimix matches simulations", {
  ...
  temp2=as.vector(comp_postmean2(g,set_data(3,2,3)))
  temp = as.vector(comp_postmean(g,set_data(3,2,3)))
